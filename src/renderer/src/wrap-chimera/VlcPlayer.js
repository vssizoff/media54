...
import VlcAudio from "./VlcAudio";
import VlcPlaylist from "./VlcPlaylist";
import VlcInput from "./VlcInput";
import VlcSubtitles from "./VlcSubtitles";
...
class VlcPlayer extends EventEmitter {
     ...
     */
    get state() {
        return enums.StateValues[this._player.state];
    }
     ...
     */
    get pixelFormat() {
        return enums.PlayerPixelFormat[this._player.pixelFormat];
    }
    ...
    set pixelFormat(format) {
        if (!enums.PlayerPixelFormat.includes(format))
            throw new Error("PlayerPixelFormat should be one of " + enums.PlayerPixelFormat.toString())
        this._player.pixelFormat = enums.PlayerPixelFormat.indexOf(format);
    }
